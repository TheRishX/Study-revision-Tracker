...
export const TodoWidget: React.FC<TodoWidgetProps> = ({ soundMuted }) => {
  ...
  return (
    <div className="momentum-todo fixed top-[76px] right-4 sm:right-6 z-40 flex flex-col-reverse items-end">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="momentum-todo-panel mt-3 w-[calc(100vw-2rem)] max-w-80 sm:max-w-96 bg-stone-900/90 backdrop-blur-2xl border border-white/20 text-white rounded-3xl p-4 shadow-2xl overflow-hidden"
          >
            {/* Header */}
