...
Version 3.1.1 includes the customizable Topic Tracker, Markdown hierarchy import,
...
4. Select this folder’s `dist` directory, or unzip `ReWise-Complete-3.1.1.zip` and select
